...
import { Autocomplete, TextField, Grid, Button, Dialog, DialogActions, DialogContent, DialogTitle, DialogContentText, MenuItem, Snackbar, Alert, Fab, Tooltip, Zoom, InputAdornment, Box, Typography, Stack } from '@mui/material';
                ...
                {openAddProductDialog && (
                    <motion.div initial="hidden" animate="visible" exit="exit" variants={dialogVariants}>
                        <Dialog open={openAddProductDialog} onClose={() => setOpenAddProductDialog(false)} maxWidth="md" fullWidth>
                            <DialogTitle sx={{ fontWeight: 700, fontSize: 22, color: "#1976d2", borderBottom: '1px solid #e0e0e0' }}>
                                Add New Product
                            </DialogTitle>
                            <DialogContentStyled>
                                <form onSubmit={handleAddProduct}>
                                    <Stack spacing={3}>
                                            ...
                                            <Grid container spacing={2}>
                                                ...
                                                <Grid item xs={12}>
                                                    <TextField
                                                        ...
                                                        InputProps={{
                                                            startAdornment: (
                                                                <InputAdornment position="start"><DescriptionIcon color="action" /></InputAdornment>
                                                            ),
                                                        }}
                                                    />
                                                </Grid>
                                        ...
                                        <DialogCard variants={cardVariants}>
                                            <Typography variant="h6" fontWeight={600} mb={2}>Pricing & Stock</Typography>
                                            <Grid container spacing={2}>
                                                <Grid item xs={12} sm={6}>
                                                    <TextField
                                                        ...
                                                        InputProps={{
                                                            startAdornment: (
                                                                <InputAdornment position="start"><AttachMoneyIcon color="action" /></InputAdornment>
                                                            ),
                                                        }}
                                                    />
                                                </Grid>
                                                <Grid item xs={12} sm={6}>
                                                    <TextField
                                                        ...
                                                        InputProps={{
                                                            startAdornment: (
                                                                <InputAdornment position="start"><AddShoppingCartIcon color="action" /></InputAdornment>
                                                            ),
                                                        }}
                                                    />
                                                </Grid>
                                                <Grid item xs={12}>
                                                    <TextField
                                                        ...
                                                        InputProps={{
                                                            startAdornment: (
                                                                <InputAdornment position="start"><GavelIcon color="action" /></InputAdornment>
                                                            ),
                                                        }}
                                                    >
                                        ...
                                        <DialogCard variants={cardVariants}>
                                            <Typography variant="h6" fontWeight={600} mb={2}>Media & Category</Typography>
                                            <Grid container spacing={2}>
                                                <Grid item xs={12} sm={8}>
                                                    <TextField
                                                        ...
                                                        InputProps={{
                                                            startAdornment: (
                                                                <InputAdornment position="start"><PhotoCameraIcon color="action" /></InputAdornment>
                                                            ),
                                                        }}
                                                    />
                                                </Grid>
                                                ...
                                                <Grid item xs={12} container spacing={1} alignItems="center">
                                                    <Grid item xs={10}>
                                                        <Autocomplete
                                                            ...
                                                            renderInput={(params) => (
                                                                <TextField {...params} label="Category" InputProps={{ ...params.InputProps, startAdornment: <InputAdornment position="start"><CategoryIcon color="action" /></InputAdornment> }} />
                                                            )}
                                                            fullWidth
                                                            required
                                                        />
                ...
                {openAddCategoryDialog && (
                    <motion.div initial="hidden" animate="visible" exit="exit" variants={dialogVariants}>
                        <Dialog open={openAddCategoryDialog} onClose={() => setOpenAddCategoryDialog(false)} maxWidth="sm" fullWidth>
                            <DialogTitle sx={{ fontWeight: 700, fontSize: 20, borderBottom: '1px solid #e0e0e0' }}>Add New Category</DialogTitle>
                            <DialogContentStyled>
                                <Stack spacing={2}>
                                    <TextField
                                        fullWidth
                                        ...
                                        InputProps={{
                                            startAdornment: (
                                                <InputAdornment position="start"><CategoryIcon color="action" /></InputAdornment>
                                            ),
                                        }}
                                    />
                                    <TextField
                            ...
                            <DialogActions sx={{ p: 2, borderTop: '1px solid #e0e0e0' }}>
                                <Button onClick={() => setOpenAddCategoryDialog(false)} sx={{ textTransform: 'none', color: 'text.secondary' }}>Cancel</Button>
                                <Button onClick={handleAddCategory} variant="contained" color="primary" sx={{ textTransform: 'none' }}>Add Category</Button>
                            </DialogActions>
                        </Dialog>
                    </motion.div>
                )}
