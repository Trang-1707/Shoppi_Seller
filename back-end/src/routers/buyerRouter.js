...
buyerRouter.get("/vouchers-seller/code/:code", getVoucherSellerByCode); //thêm để user lấy code của seller
...
disputeRoutes.get(
  ...
  disputeController.checkDisputeEligibility
);
...
buyerRouter.get(
  "/return-requests",
  returnRequestController.getUserReturnRequests
);
buyerRouter.get(
  "/return-requests/:id",
  returnRequestController.getReturnRequestDetail
);
buyerRouter.delete(
  "/return-requests/:id",
